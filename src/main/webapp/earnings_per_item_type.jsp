        ...
        <tbody>
            <%
                try {
                    ...
                    // Execute SQL query
                    PreparedStatement statement = con.prepareStatement("SELECT v.type AS item_type, COALESCE(SUM(a.highest_bid), 0) AS total_earnings FROM vehicles v LEFT JOIN auctions a ON a.VIN = v.VIN AND a.close_time < NOW() GROUP BY v.type");
